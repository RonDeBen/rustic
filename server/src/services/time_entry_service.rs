...
pub async fn switch_to_timer(pool: &PgPool, id: i32) -> Result<TimeEntry, sqlx::Error> {
...
pub async fn pause_timer(pool: &PgPool, entry: TimeEntry) -> Result<TimeEntry, sqlx::Error> {
